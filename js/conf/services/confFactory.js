...
Curiosity.factory("conf", function($rootScope, elasticClient, elasticFunc, log){
	...
	*/
	...
	{
	  "contextName": "basicSearch",
	  "contextDesc": "This context is usefull to just process a search and explore quickly an index.\nChoose it, select your index, eventualy add query string paramters and acces yours docs.",
	  "agg": [],
	  "filters": {
	    "filters": {
	      "opBool": "And",
	      ...
	      "modules": [
	        {
	          "name": "module969186",
	          "display": true,
	          "template": "partials/notebook/notebook.html",
	          "id": 6,
	          "$$hashKey": "0R4"
	        },
	        {
	          "name": "module147804",
	          "display": true,
	          "template": "partials/request_module/partials/request_form.html",
	          "id": 2,
	          "$$hashKey": "02X"
	        },
	        {
	          "name": "module462756",
	          "display": true,
	          "template": "partials/request_module/partials/request_option_bar.html",
	          "id": 3,
	          "$$hashKey": "02Y"
	        },
	        {
	          "name": "module238113",
	          "display": true,
	          "template": "partials/request_module/partials/request_pagination.html",
	          "id": 4,
	          "$$hashKey": "02Z"
	        },
	        {
	          "name": "module254706",
	          "display": true,
	          "template": "partials/request_module/partials/request_result_display.html",
	          "id": 5,
	          "$$hashKey": "030"
	        }
	      ],
	  ...
	  "curiosity": {
	    "server": globalConf.defaultServer,
	    "index": ""
	  },
	  "notebook": {
	    "currentNotebook": [
